...
export function AdminSidebar({ isMobileMenuOpen, setIsMobileMenuOpen }: AdminSidebarProps) {
    ...
    const menuItems = [
        ...
        { label: "Médecins", icon: <FiUsers />, href: "/admin/doctors" },
        { label: "Patients", icon: <FiUser />, href: "/admin/patients" },
        { label: "Signalements", icon: <FiAlertCircle />, href: "/admin/reports" },
        { label: "Paramètres", icon: <FiSettings />, href: "/admin/settings" },
    ];
